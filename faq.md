...
__A:__ EOD data has a [limit][data_format] of 1000 symbols per repository. 
If you have more than 1,000 CSV data files, you can create another data repository.
